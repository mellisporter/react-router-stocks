...
const StockValue =(props) => {
    // const apiKey="83ea3c078fce891681c4ec51c69976bc";
    ...
    // do we not use state for this?? much different than in class with the api
    ...
    const data = [
      ...
      // filters the data by the symbol that is in the URL, letting react know which is selected

    const stock = data.find(function (item){
     return (item.symbol === props.match.params.symbol);
    });
  ...
  return (
    <div>
      ...
      <a href="/stocks">Return to Stocks</a>
    </div>
  )
}
